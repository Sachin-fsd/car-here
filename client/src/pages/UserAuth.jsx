      ...
      <div className="w-full max-w-md bg-slate-800/90 backdrop-blur-xl p-8 rounded-2xl shadow-2xl relative border border-slate-700/50 z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-white tracking-tight">
            {isLogin ? 'Welcome Back' : 'Join CarHere'}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {!isLogin && (
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent text-white placeholder-slate-400 transition-all"
                required
              />
            </div>
          )}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 bg-slate-700/50 border border-slate-600/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent text-white placeholder-slate-400 transition-all"
                required
              />
              <button
                type="button"
          ...
          <button 
            type="submit" 
            className="w-full py-3 rounded-lg bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-bold shadow-lg hover:from-cyan-500 hover:to-blue-600 transition-all duration-300 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed" 
            disabled={loading}
          >
            {loading ? (
            ...
            <div className="bg-slate-800/95 backdrop-blur-xl p-8 rounded-2xl shadow-2xl w-96 border border-slate-700/50 mx-4">
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button 
                    type="submit" 
                    className="flex-1 py-2.5 rounded-lg bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-medium shadow-lg hover:from-cyan-500 hover:to-blue-600 transition-all"
                  >
                    Send Reset Link
                  </button>
                  <button 
              ...
              {forgotMsg && (
                <div className="text-center text-sm mt-4 p-3 rounded-lg bg-cyan-900/20 border border-cyan-500/20 text-cyan-400">
                  {forgotMsg}
                </div>
              )}
            </div>
